...
const AgreementClientFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_agreementclient_free(ptr >>> 0, 1));
...
export class AgreementClient {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        AgreementClientFinalization.unregister(this);
        return ptr;
    }
    ...
    get version() {
        ...
        try {
            ...
            const ret = wasm.__wbg_get_agreementclient_version(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    set version(arg0) {
        ...
        wasm.__wbg_set_agreementclient_version(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {string} addr
     */
    ...
    get_man_page(command) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.agreementclient_get_man_page(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @param {CreateThingIndto} indto
     * @returns {Promise<CreateThingOutdto>}
     */
    create_thing(indto) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        _assertClass(indto, CreateThingIndto);
        if (indto.__wbg_ptr === 0) {
            throw new Error('Attempt to use a moved value');
        }
        var ptr0 = indto.__destroy_into_raw();
        const ret = wasm.agreementclient_create_thing(this.__wbg_ptr, ptr0);
        return ret;
    }
}

const CreateThingIndtoFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_createthingindto_free(ptr >>> 0, 1));

export class CreateThingIndto {

    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        CreateThingIndtoFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_createthingindto_free(ptr, 0);
    }
    /**
     * @returns {string}
     */
    get name() {
        ...
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            _assertNum(this.__wbg_ptr);
            const ret = wasm.__wbg_get_createthingindto_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set name(arg0) {
        ...
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_createthingindto_name(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    get opt_prop() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.__wbg_get_createthingindto_opt_prop(this.__wbg_ptr);
    ...
    set opt_prop(arg0) {
        ...
        wasm.__wbg_set_createthingindto_opt_prop(this.__wbg_ptr, !isLikeNone(arg0), isLikeNone(arg0) ? BigInt(0) : arg0);
    }
    /**
     * @param {string} name
     */
    constructor(name) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.createthingindto_new(ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
        CreateThingIndtoFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}

const CreateThingOutdtoFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_createthingoutdto_free(ptr >>> 0, 1));

export class CreateThingOutdto {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(CreateThingOutdto.prototype);
        obj.__wbg_ptr = ptr;
        CreateThingOutdtoFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        CreateThingOutdtoFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_createthingoutdto_free(ptr, 0);
    }
    /**
     * @returns {string}
     */
    get id() {
        ...
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            _assertNum(this.__wbg_ptr);
            const ret = wasm.__wbg_get_createthingoutdto_id(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set id(arg0) {
        ...
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_createthingoutdto_id(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {string}
     */
    get name() {
        ...
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            _assertNum(this.__wbg_ptr);
            const ret = wasm.__wbg_get_createthingoutdto_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set name(arg0) {
        ...
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_createthingoutdto_name(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {bigint | undefined}
     */
    get opt_prop() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.__wbg_get_createthingoutdto_opt_prop(this.__wbg_ptr);
        return ret[0] === 0 ? undefined : BigInt.asUintN(64, ret[1]);
    }
    /**
     * @param {bigint | undefined} [arg0]
    ...
    set opt_prop(arg0) {
        ...
        wasm.__wbg_set_createthingoutdto_opt_prop(this.__wbg_ptr, !isLikeNone(arg0), isLikeNone(arg0) ? BigInt(0) : arg0);
    }
}

const DateTimeUtcFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_datetimeutc_free(ptr >>> 0, 1));
...
export class DateTimeUtc {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(DateTimeUtc.prototype);
        obj.__wbg_ptr = ptr;
        DateTimeUtcFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        DateTimeUtcFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_datetimeutc_free(ptr, 0);
    }
    /**
     * @returns {string}
     */
    get 0() {
        ...
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            _assertNum(this.__wbg_ptr);
            const ret = wasm.__wbg_get_datetimeutc_0(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set 0(arg0) {
        ...
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_datetimeutc_0(this.__wbg_ptr, ptr0, len0);
    }
}

const ErrorOutdtoFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_erroroutdto_free(ptr >>> 0, 1));
...
export class ErrorOutdto {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ErrorOutdto.prototype);
        obj.__wbg_ptr = ptr;
        ErrorOutdtoFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ErrorOutdtoFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_erroroutdto_free(ptr, 0);
    }
    /**
     * @returns {string}
     */
    get id() {
        ...
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            _assertNum(this.__wbg_ptr);
            const ret = wasm.__wbg_get_erroroutdto_id(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set id(arg0) {
        ...
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_erroroutdto_id(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {string}
     */
    get msg() {
        ...
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            _assertNum(this.__wbg_ptr);
            const ret = wasm.__wbg_get_erroroutdto_msg(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set msg(arg0) {
        ...
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_erroroutdto_msg(this.__wbg_ptr, ptr0, len0);
    }
}

const ManGetOutdtoFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mangetoutdto_free(ptr >>> 0, 1));

export class ManGetOutdto {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ManGetOutdto.prototype);
        obj.__wbg_ptr = ptr;
        ManGetOutdtoFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ManGetOutdtoFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mangetoutdto_free(ptr, 0);
    }
    /**
     * @returns {DateTimeUtc}
     */
    get generated_at() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.__wbg_get_mangetoutdto_generated_at(this.__wbg_ptr);
        return DateTimeUtc.__wrap(ret);
    }
    /**
     * @param {DateTimeUtc} arg0
     */
    set generated_at(arg0) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        _assertClass(arg0, DateTimeUtc);
        if (arg0.__wbg_ptr === 0) {
            throw new Error('Attempt to use a moved value');
        }
        var ptr0 = arg0.__destroy_into_raw();
        wasm.__wbg_set_mangetoutdto_generated_at(this.__wbg_ptr, ptr0);
    }
    /**
     * @returns {string}
     */
    get output() {
        ...
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            _assertNum(this.__wbg_ptr);
            const ret = wasm.__wbg_get_mangetoutdto_output(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set output(arg0) {
        ...
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_mangetoutdto_output(this.__wbg_ptr, ptr0, len0);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_append_73ca8abc548ccdbc = function() { return logError(function (arg0, arg1, arg2, arg3, arg4) {
    ...
    imports.wbg.__wbg_createthingoutdto_new = function() { return logError(function (arg0) {
        const ret = CreateThingOutdto.__wrap(arg0);
        return ret;
    }, arguments) };
    ...
    imports.wbg.__wbg_erroroutdto_new = function() { return logError(function (arg0) {
        const ret = ErrorOutdto.__wrap(arg0);
        return ret;
    }, arguments) };
    ...
    imports.wbg.__wbg_mangetoutdto_new = function() { return logError(function (arg0) {
        const ret = ManGetOutdto.__wrap(arg0);
        return ret;
    }, arguments) };
    ...
    imports.wbg.__wbindgen_closure_wrapper1833 = function() { return logError(function (arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 58, __wbg_adapter_48);
        return ret;
    }, arguments) };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('agreement_client_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
